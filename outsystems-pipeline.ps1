pipeline {
  ...
  environment {
    ...
    LifeTimeHostname = 'sonae-lt.outsystemsenterprise.com'
    ...
    */
    ...
    AcceptanceEnvironment = 'Development Core'
    PreProductionEnvironment = 'Pre-Production'
    ProductionEnvironment = 'Production'
    // Regression URL Specification
    ProbeEnvironmentURL = 'https://sonae-tst.outsystemsenterprise.com/'
    BddEnvironmentURL = 'https://sonae-tst.outsystemsenterprise.com/'
  }
  stages {
